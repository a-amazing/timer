package com.wangyi.timer.component;

import com.wangyi.timer.dao.STimetask;
import com.wangyi.timer.dao.STimetaskExample;
import com.wangyi.timer.exception.QuartzJobFactoryDisallowConcurrentExecution;
import com.wangyi.timer.service.STimetaskService;
import com.wangyi.timer.task.QuartzJobFactory;
import com.wangyi.timer.task.ScheduleJob;
import com.wangyi.timer.util.ApplicationContextUtils;
...
public class InitQuartzJob implements ApplicationContextAware {
    ...
    public static void init() {
        ...
        for (STimetask sTimetask : list) {
            ...
            job1.setIsConcurrent(sTimetask.getIsConcurrent() ? "1" : "0"); // 运行状态
